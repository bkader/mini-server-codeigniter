...
if NOT exist core\mysql\data\mysql_mini.pid goto :ALREADYKILLED
...
:RUNNING
rem ## Getdrive letter
SET /P Disk=<core\mysql\data\drive.txt

rem ## Remove pid file server was closed
del core\mysql\data\mysql_mini.pid

rem ## Remove disk file
del core\mysql\data\drive.txt

rem ## Kill server
core\mysql\bin\mysqladmin.exe --port=3311 --user=root --password=root shutdown
