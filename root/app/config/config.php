...
|
*/
$config['log_path'] = DOCROOT.'root'.DS.'logs'.DS.date('Y').DS.date('m').DS;
...
|
*/
$config['cache_path'] = DOCROOT.'cache/';
...
|
*/
$config['modules_locations'] = array(DOCROOT.'root'.DS.'modules'.DS);
...
/* Location: ./root/app/config/config.php */